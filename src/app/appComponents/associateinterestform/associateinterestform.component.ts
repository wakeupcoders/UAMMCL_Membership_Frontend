...
@Component({
  selector: 'app-associateinterestform',
  templateUrl: './associateinterestform.component.html',
  styleUrls: ['./associateinterestform.component.css']
})
export class AssociateinterestformComponent implements OnInit {
  ...
  registrationForm: FormGroup;
   ...
   onSubmit() {
     ...
     if (this.editMode) {
         ...
         this.nominalService.EditNominalMembershipForm(this.registrationForm.value, this.selectedMemberID).subscribe({
           next: (response) => {
            ...
            Swal.fire({
              ...
              confirmButtonColor: '#28a745'  // Optional: Bootstrap green
            });
       ...
       //Add New Record
       this.nominalService.submitAssociatesInterestForm(this.registrationForm.value).subscribe(res => {
         this.nominalMembers = res;
         this.isLoading = false;
         Swal.fire({
           title: 'Success!',
