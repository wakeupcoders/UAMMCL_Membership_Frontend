...
@Component({
  selector: 'app-nominalreceipt',
  templateUrl: './nominalreceipt.component.html',
  styleUrls: ['./nominalreceipt.component.css']
})
export class NominalreceiptComponent implements OnInit {
